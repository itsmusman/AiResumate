export function template37(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
...
<div class="doc-item">
  ...
  function renderSkills() {
    ...
    if (skills && skills.length > 0) {
      ...
      skillsHtml = `
        <div id="SECTION_SKILLS" class="section skills SECTION_SKILLS noparagraph multi-para has-title" data-section-cd="SKILLS">
          <div class="doc-item">
            <div class="heading">
              <div class="sectiontitle" id="SECTIONNAME_SKILLS">
                Skills<span title=" Skills " class="rename-section text-rename"></span>
              </div>
            </div>
            <div
            id="PARAGRAPH_EDUC_0"
      ...
      hobbyHtml = `
        <div id="SECTION_SKILLS" class="section skills SECTION_SKILLS noparagraph multi-para has-title" data-section-cd="SKILLS">
          <div class="doc-item">
            <div class="heading">
              <div class="sectiontitle" id="SECTIONNAME_SKILLS">
                Hobbies<span title=" Skills " class="rename-section text-rename"></span>
              </div>
            </div>
      ...
      experience.forEach((element) => {
        ...
        <div class="sortableInner">
          <div id="PARAGRAPH_EXPR_0" class="paragraph PARAGRAPH_EXPR firstparagraph placeholder-text">
            <div class="clearfix doc-item">
              <div class="singlecolumn">
                <div class="disp-block datewrapper" dependency="JSTD|EDDT">
                  <span class="jobdates" id="FIELD_JSTD" format="%m.%Y">${
                    element.fromYear
                  }${cleanMonth(element.fromMonth)}</span>
                  <span dependency="JSTD+EDDT"> - </span>
                  <span class="jobdates" id="FIELD_EDDT" format="%m.%Y">${
                    element.toYear
                ...
                <div>
                  ...
                  <span class="disp-block locationGap" dependency="COMP|JSTA|JCIT|JCNT|JCTR|JLOC">
              ...
              <div class="singlecolumn">
                <div>
                  ...
                  <div>
                    ...
                    <span dependency="DGRE|STUY|SCHO">
                      <span dependency="SCIT|SSTA|SCNT|GRHN"> - </span>
                    </span>
                    <span class="joblocation jobcity" id="FIELD_SCIT">${
                      element.city ?? ""
                    }</span>
                        ...
                        <div>
                          <div class="name" dependency="FNAM|LNAM">
                            ...
                            ${personDetail.firstName}
                             ...
                             <span> </span>
                             <span class="field" id="FIELD_LNAM">
