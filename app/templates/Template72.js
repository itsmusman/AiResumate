export function template72(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
                ...
                >
                  <div class="clearfix doc-item">
                    <div class="singlecolumn">
                      ...
                      <span
                        class="dispBlk"
                        dependency="SCHO|SCIT|SSTA|SCNT|GRYR|GRST|GRED|GRIP"
                      >
                        <span
                          class="txt-bold txtCapitalize"
                          id="FIELD_SCHO"
                        ...
                        ><span dependency="SCHO"
                          ><span
                            dependency="SCIT|SSTA|SCNT|GRYR|GRST|GRED|GRIP"
                          >
                            -
                          </span></span
                        >
    ...
    personDetail.email
            ...
            <div id="CONTAINER_PARENT_1" class="parent-container">
              <div id="CONTAINER_1">
                ...
                <div data-react-beautiful-dnd-draggable="231" class="sortable-item section-container SortableItem-sibling data-EXPR">
                  <div class="document-tool sec-tool" id="editIcons" style="right: -2px"></div>
