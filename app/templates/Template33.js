export function template33(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
          ...
          <div id="PARAGRAPH_EXPR_0" class="paragraph PARAGRAPH_EXPR firstparagraph placeholder-text">
            <div class="clearfix doc-item">
              <div class="singlecolumn">
                ...
                <span class="txt-bold" dependency="COMP+JTIT"> - </span>
                <span class="semi-bold" id="FIELD_JTIT">${
                  element.position
                }</span>
                <span dependency="JTIT"><span dependency="JCIT|JSTA|JCNT|JLOC">,</span></span>
      ...
      <div class="">
        <div class="">
          <div id="PARAGRAPH_EDUC_0" class="paragraph PARAGRAPH_EDUC firstparagraph placeholder-text">
            <div class="clearfix doc-item">
              <div class="singlecolumn">
                <span class="paddedline degree-gap" dependency="DGRE|STUY|GRPA|GRHN">
                  <span dependency="DGRE+STUY"><span class="beforecolonspace"> </span></span>
                  <span id="FIELD_STUY">${element.degree}</span>
                  <span dependency="DGRE|STUY"></span>
                  <span id="FIELD_GRHN"></span>
                </span>
                <span class="paddedline" dependency="SCHO|SCIT|SSTA|GRYR|GRST|GRED|GRIP">
                  <span id="FIELD_SCHO">${element.university}</span>
                  <span dependency="SCHO"></span><br/>
                  <span id="FIELD_SCIT">${element?.city ?? []}</span>
                  <span id="FIELD_SCNT"></span><br/>
                  ...
                  <span class="jobdates" id="FIELD_GRST" format="%B %Y"></span>
                  <span class="jobdates" id="FIELD_GRED" format="%B %Y"></span>
