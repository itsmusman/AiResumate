export function template44(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
        ...
        <div class="edu">
         <h3 class="title">CERTIFICATION</h3>
            ${certificates
              ...
              <p class="item_preTitle">${element.Year}${cleanMonth(
                    element.fromMonth
                  )}</p>
...
<h4 class="item_title">${element.company}</h4>
<p class="item_subtitle">${element?.city ?? []}</p>
