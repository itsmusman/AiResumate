export function template66(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
  ...
  <div class="singlecolumn">
    ...
    <span
      class="paddedline txtItl"
      dependency="JCIT|JSTA|JCNT|JLOC|JCTR"
    >
    ...
    >
      ...
      ><span id="FIELD_EDDT" format="%m/%Y"
        >${element.fromMonth ? element.fromMonth : []} / ${
        element.fromYear ? element.fromYear : "Current"
      }</span
      >
    </span>
    ...
    >
      <div class="clearfix doc-item">
        <div class="singlecolumn">
          <span
            class="paddedline txtItl"
            dependency="GRYR|GRST|GRED|GRIP"
          >
            <span
          ...
          <span class="paddedline" dependency="SCHO">
            <span class="companyname txt-bold" id="FIELD_SCHO"
              >${element.university}</span
            >
          </span>
          <span
            class="paddedline"
            dependency="SCIT|SSTA|SCNT"
          >
          ...
          <span
            class="paddedline degreeDetails"
      ...
      @page {
        margin: 0px;
            ...
            .genie .cntcSec {
              ...
              border-top: none !important;
              border-bottom: 11px solid #A81A2B;
              padding-top: 0px;
            }
            .genie .name {
              font-size: 24px;
