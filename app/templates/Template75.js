export function template75(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
  ...
  function renderAwards() {
    ...
    awards.forEach((element) => {
      result =
        result +
        `<p>${element.award}<p><span> </span><p>${element.institute}<p>
