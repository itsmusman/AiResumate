export function template15(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
  ...
  function renderCertificate() {
    ...
    if (certificates && certificates.length > 0) {
      certificateHtml = `<div class="heading">
  ...
  <div class="paragraph first-paragraph">
    ...
    <div class="single-column">
      <span class="padded-line"
        ><span class="degree"></span
        ><span class="program-line">${element.awards} (${element.institute})</span>
      </span>
      <span class="padded-line txtItalics"
        ><span class="job-location jobcity"
          >${element.Year}</span
  ...
  function renderReferences() {
    ...
    if (references && references.length > 0) {
      referencesHtml = `<div class="heading">
      <div class="headingIcon"></div>
  ...
  function renderHobbies() {
    ...
    if (hobbies && hobbies.length > 0) {
      hobbyHtml = `
        ...
        <div class="paragraph first-paragraph">
          <span class="companyname">${hobbies
            .map((element) => element.name)
            .join(", ")}</span>
        </div>`;
    }
        ...
        result += `
          ...
          <div class="single-column">
            ...
            ><span class="padded-line txtItalics pb5"
              ...
              ><span class="job-location jobcity"></span
              ><span>, </span
              ><span class="companyname">${element?.city ?? []} </span></span
            ><span class="padded-line"
              ><span class="jobline"
                ><ul>`;
      ...
      education.forEach((element) => {
        result += `<div class="paragraph first-paragraph">
          ...
          <div class="single-column">
            <span class="padded-line">
              <span class="degree"></span>
              <span class="program-line">${element.degree}${
          element.university
        }</span>
            </span>
            <span class="padded-line txtItalics">
    ...
    <div class="top-section">
      <div class="left-box">
        <div class="section nameSec notdraggable first-section">
          <div class="paragraph first-paragraph">
            <div class="name">
              <span class="field fName">${personDetail.firstName}</span>
              <span class="field">${personDetail.lastName}</span>
            </div>
            ...
            <div class="address">
              <div class="addressLeft">
                <div>
                  ...
                  ><span class="field"></span><span class="spaced field">${
                    personDetail.city
                  }</span><span>, </span
                  ><span class="spaced field">${personDetail.country}, 
                 ${personDetail.phone}, ${personDetail.email}</span>
                </div>
              </div>
