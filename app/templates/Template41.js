export function template41(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
        ...
        <div class="title">
          <i class="fa fa-briefcase" aria-hidden="true"></i>
            ...
            ${certificates
              ...
              <span>${element.Year}${cleanMonth(element.fromMonth)}</span> </h3>
