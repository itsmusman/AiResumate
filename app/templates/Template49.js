export function template49(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
  ...
  function renderCertificate() {
    ...
    if (certificates && certificates.length > 0) {
      certificateHtml = `<section class="main-block concise">
        <h2>
         ...
         <div class="details">
           <header>
             ...
             <span class="place">${element.institute}</span>
  ...
  function renderAwards() {
    ...
    if (awards && awards.length > 0) {
      awardsHtml = `<section class="main-block concise">
        <h2>
  ...
  function renderReferences() {
    ...
    if (references && references.length > 0) {
      referencesHtml = `<section class="main-block concise">
        <h2>
  ...
  function renderSkills() {
    ...
    if (skills && skills.length > 0) {
      skillsHtml = `<section class="main-block">
        <h2>
  ...
  function renderHobbies() {
    ...
    if (hobbies && hobbies.length > 0) {
      hobbyHtml = `<section class="main-block">
        <h2>
          <i class="fa fa-cogs"></i> Hobbies
        </h2>
        <ul class="skills-list">
  ...
  function renderExperience() {
    ...
    experience.forEach((element) => {
      result += `<section class="blocks">
<div class="date">
  <span>${cleanMonth(element.fromMonth)}${element.fromYear}</span><span>
  ${element.toMonth}${element.toYear}</span>
</div>
<div class="decorator">
</div>
<div class="details">
  <header>
    ...
    <span class="place">${element.company}</span>
    <span class="location">${element?.city ?? []}</span>
  </header>
  <div>
    <ul>`;
      var roles = "";
  ...
  function renderEducation() {
    ...
    education.forEach((element) => {
      result =
        ...
        `<section class="blocks">
<div class="date">
  <span>${element.fromYear}</span><span>${element.toYear}</span>
</div>
<div class="decorator">
</div>
<div class="details">
  <header>
    ...
    <span class="place">${element.university}</span>
    <span class="location">${element.city ?? []}</span>
  </header>
      ...
      <body lang="en">
        <section id="main">
          <header id="title">
            ...
            <span class="subtitle"><b>${jobPosition}</b></span>
            <p class="subtitle">${userSummary}</p>
          </header>
        ...
        <aside id="sidebar">
          <div class="side-block" id="contact">
            ...
            <ul>
              <li><i class="fa fa-linkedin"></i>${personDetail.website}</li>
              <li><i class="fa fa-envelope"></i>${personDetail.email}</li>
              <li><i class="fa fa-phone"></i>${personDetail.phone}</li>
            </ul>
          </div>
