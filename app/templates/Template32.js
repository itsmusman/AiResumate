export function template32(resume) {
  var {
    personDetail,
    educationDetail,
    workExperience,
  ...
  function renderCertificate() {
    ...
    if (certificates && certificates.length > 0) {
      certificateHtml = `<div data-react-beautiful-dnd-draggable="227" class="sortable-item section-container SortableItem-sibling data-EDUC">
...
`
  ...
  function renderAwards() {
    ...
    if (awards && awards.length > 0) {
      awardsHtml = `<div data-react-beautiful-dnd-draggable="227" class="sortable-item section-container SortableItem-sibling data-EDUC">
      <div class="document-tool sec-tool" id="editIcons" style="right: -2px"></div>
      <div id="SECTION_EDUC476ef462-3a42-43d6-a629-bf2e3c1ef6ac" class="section education SECTION_EDUC noparagraph multi-para has-title" data-section-cd="EDUC">
        <div class="doc-item">
          <div class="heading">
                 ...
                 <div class="singlecolumn">
                   ...
                   >
                     <span
                       class="xslt_static_change displayNoneThisField"
                       >Expected in </span
                     ><span id="FIELD_GRYR" format="%B %Y">${element.Year}</span>
 ...
 `
  ...
  function renderReferences() {
    ...
    if (references && references.length > 0) {
      referencesHtml = `<div data-react-beautiful-dnd-draggable="227" class="sortable-item section-container SortableItem-sibling data-EDUC">
      <div class="document-tool sec-tool" id="editIcons" style="right: -2px"></div>
      <div id="SECTION_EDUC476ef462-3a42-43d6-a629-bf2e3c1ef6ac" class="section education SECTION_EDUC noparagraph multi-para has-title" data-section-cd="EDUC">
        <div class="doc-item">
          <div class="heading">
      ...
      skillsHtml = `
        <div class="doc-item">
          ...
          <div class="single-column">
            ${skills
              .map(
                (element) => `<span class="padded-line">${element.name}</span>`
              )
              .join(", ")}
          </div>
        </div>
              ...
              <div class="singlecolumn">
                <span class="paddedline exp-txtsize">
                  ...
                  <span dependency="JTIT">
                    <span dependency="COMP|JCIT|JSTA|JCNT|JLOC">,</span>
                  </span>
                  <span class="txt-bold txt-itlc" id="FIELD_COMP">
                    ${element.company}
                  </span>
                  <span dependency="COMP"></span>
            ...
            <div class="clearfix doc-item">
              <div class="singlecolumn">
                ...
                >
                  ...
                  <span class="paddedline" dependency="DGRE|STUY|GRHN|GRPA">
                  ...
                  <span class="paddedline" dependency="SCHO|SCIT|SSTA|SCNT">
                    <span id="FIELD_SCHO">${element.university}</span>
                    <span dependency="SCHO">
                      <span dependency="SSTA|SCIT|SCNT"> ,</span>
                    </span>
                    <span class="joblocation" id="FIELD_SCIT">${
                      element?.city ?? []
                    }</span>
                    <span class="joblocation" id="FIELD_SSTA"></span>
                    <span class="joblocation" id="FIELD_SCNT"></span>
                  </span>
                </span>
                <span class="field" id="FIELD_FRFM"></span>
              </div>
  ...
  <head>
    ...
    @page {
      margin: 0px;
          ...
          .genie .name:before {
            content: "";
            border-bottom: 4px solid #b41c2e;
            position: absolute;
            left: 0;
            bottom: 0;
            width: 41px;
  ...
  <body>
    ...
    personDetail.country
                            ...
                            <div class="icon-row" dependency="HPHN|CPHN">
                              <div class="icoTxt">
                                <span class="xslt_static_change txt-bold"></span><span class="txt-bold"></span> <span class="field" id="FIELD_HPHN">${
                                  personDetail.phone
